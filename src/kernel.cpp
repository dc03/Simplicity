...
__attribute__((section(".stivale2hdr"), used)) static struct stivale2_header stivale_hdr = {.entry_point = 0,
...
extern "C" void _start(struct stivale2_struct *stivale2_struct) {
    ...
    term_str_tag = reinterpret_cast<stivale2_struct_tag_terminal *>(
